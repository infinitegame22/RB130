...
input: an array of elements and an empty collection
output: the new collection with its elements

Rules: 
- if array input is empty, return the original object passed as second argument
- method may use #each, #each_with_index, #inject, loop, for, while, or until
...
1 is passed to the block, squared and added to the list
3 is passed to the block, squared and added to the list
5 is passed to the block, squared and added to the list
...
A:
- two parameters: `array`, `collection`
